...
public class Share : MonoBehaviour {
		...
		public Sprite ShareButtonImage;
		Color Colour;
		//function called from a button
		public void ButtonShare ()
		{
			//Admob.Instance ().removeNativeBanner ("mainmenu");
			for(int i=0;i<Buttons.Length;i++)
			{

				Colour=Buttons[i].gameObject.GetComponent<Image>().color;
				Colour.a=0;
				Buttons[i].gameObject.GetComponent<Image>().color=Colour;
