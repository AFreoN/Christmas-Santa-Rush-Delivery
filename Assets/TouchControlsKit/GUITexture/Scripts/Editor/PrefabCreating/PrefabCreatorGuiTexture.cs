...
namespace TouchControlsKit.GuiTexture.Inspector
{
    public sealed class PrefabCreatorGuiTexture : Editor
    {
        ...
        private static void CreateButton()
        {
            ...
            btnTemp.normalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/ButtonNormal.png" );
            btnTemp.pressedTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/ButtonPressed.png" );
        ...
        private static void CreateJoystick()
        {
            ...
            joyTemp.joystickGUITexture.texture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/Joystick.png" );
            joyTemp.backgroundGUITexture.texture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/JoystickBack.png" );
            joyTemp.myData.touchzoneGUITexture.texture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/Touchzone.png" );
        ...
        private static void CreateTouchpad()
        {
            ...
            tpTemp.myData.touchzoneGUITexture.texture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/Touchzone.png" );
        ...
        private static void CreateDPad()
        {
            ...
            dpadTemp.myData.touchzoneGUITexture.texture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/Touchzone.png" );
            ...
            tempArrow.normalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowUpNormal.png" );
            tempArrow.pressedTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowUpPressed.png" );
            ...
            tempArrow.normalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowDownNormal.png" );
            tempArrow.pressedTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowDownPressed.png" );
            tempArrow.myData.ImageWidth = 4f;
            tempArrow.myData.ImageHeight = 4f;
            //
            ...
            tempArrow.normalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowLeftNormal.png" );
            tempArrow.pressedTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowLeftPressed.png" );
            tempArrow.myData.ImageWidth = 4f;
            tempArrow.myData.ImageHeight = 4f;
            //
            ...
            tempArrow.normalTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowRightNormal.png" );
            tempArrow.pressedTexture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Textures/ArrowRightPressed.png" );
            tempArrow.myData.ImageWidth = 4f;
            tempArrow.myData.ImageHeight = 4f;
        ...
        private static void CreateSteeringWheel()
        {
            ...
            swTemp.myData.touchzoneGUITexture.texture = AssetDatabase.LoadAssetAtPath<Texture2D>( "Assets/" + nameAbbrev + "/Base/Resources/Sprites/SteeringWheel.png" );
