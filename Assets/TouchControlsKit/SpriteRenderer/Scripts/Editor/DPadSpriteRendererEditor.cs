 ...
 * Script:		 DPadSpriteRendererEditor.cs         *
 * 													 *
...
{
    [CustomEditor( typeof( DPadSpriteRenderer ) )]
    public class DPadSpriteRendererEditor : Editor
    {
        private DPadSpriteRenderer myTarget = null;


        // OnEnable
        void OnEnable()
        {
            myTarget = ( DPadSpriteRenderer )target;
        ...
        private void ShowParameters()
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label( "DPad Name", GUILayout.Width( 115 ) );
